...
import {
  ...
  parseAvailabilityZonesXml,
  parseCarrierGatewayItems,
  parseConsoleOutput,
  parseCreatedCarrierGatewayId,
  parseCreatedRouteTableId,
  parseCreatedSecurityGroupId,
  parseCreatedSubnet,
  parseImageItems,
  parseInstanceDescription,
  parseInstanceDescriptions,
  parseInstanceStatus,
  parseInstanceTypeOfferings,
  parseInstanceTypes,
  parseRegionItems,
  parseRouteTableItems,
  parseRunInstances,
  parseSecurityGroupItems,
  parseSubnetItems,
  parseVpcItems,
} from "./ec2-xml.js";
